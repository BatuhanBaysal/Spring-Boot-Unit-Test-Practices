...
import com.batuhan.courseProjectRestApi.models.*;
...
public class StudentAndGradeServiceTest {
    ...
    public void studentInformationService() {
        ...
        assertEquals("Ali", gradebookCollegeStudentTest.getFirstname());
        assertEquals("Veli", gradebookCollegeStudentTest.getLastname());
        assertEquals("ali.veli@gmail.com", gradebookCollegeStudentTest.getEmailAddress());
    }
    ...
    public void createGradeService() {
        studentService.createGrade(80.50, 1, "math");
        studentService.createGrade(80.50, 1, "science");
        studentService.createGrade(80.50, 1, "history");
        studentService.createGrade(80.50, 1, "literature");
